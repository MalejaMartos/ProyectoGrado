...
public class VentanaGestionEstudiante extends JFrame {
    ...
    /**
     * Variable para manejar si un estudiante se va guardar en el sistema o se
     * va actualizar
     */
    ...
    DefaultTableModel modelo = new DefaultTableModel() {
        /**
         * Método que permite que las celdas de la tabla no se puedan editar
         *
         * @param row
         * @param column
         * @return
    ...
    /**
     * Método para implementar el patrón sigleton
     *
     * @return Instancia de la ventana gestion del Estudiante
     */
    ...
    /**
     * Método el cual setea los datos de la huella del estudiante
     *
     * @param datosHuella Datos de la huella dactilar
     */
    ...
    /**
     * Método el cual setea el tamaño de los datos de la huella
     *
     * @param tamanoHuella Tamaño de las huella leida
     */
    ...
    private void initComponents() {
        ...
        jButtonTomarHuella = new javax.swing.JButton();
        ...
        jButtonTomarHuella.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jButtonTomarHuella.setText("<html>Tomar <br> Huella</html>");
        jButtonTomarHuella.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonTomarHuellaActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelDatosLayout.createSequentialGroup()
                                ...
                                .addGroup(jPanelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanelDatosLayout.createSequentialGroup()
                                        .addGap(34, 34, 34)
                                        .addComponent(jButtonTomarHuella))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelDatosLayout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 34, Short.MAX_VALUE)
                                        .addGroup(jPanelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jButtonGuardar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(jButtonCancelar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                ...
                .addGroup(jPanelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelDatosLayout.createSequentialGroup()
                        .addGroup(jPanelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jButtonTomarHuella, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    /**
     * Metodo que implementa la funcion del boton Tomar Huella
     *
     * @param evt
     */
    private void jButtonTomarHuellaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTomarHuellaActionPerformed

        jTableResultado.setEnabled(false);
        jButtonGuardar.setEnabled(false);
        jButtonTomarHuella.setEnabled(false);
        

        SwingUtilities.invokeLater(hilo);

    }//GEN-LAST:event_jButtonTomarHuellaActionPerformed

    /**
     * Método el cual implementa la funcion del boton Buscar Estudiante. El cual
     * Busca un estudiante por documento de identificación o apellidos del
     * estudiante
     *
     * @param evt
     */
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        try {
            ...
            if (jTextFieldNombres.getText().isEmpty() || jTextFieldDocumento.getText().isEmpty() 
                    || jTextFieldApellidos.getText().isEmpty() || jTextFieldGrado.getText().isEmpty()
                    || jTextFieldGrupo.getText().isEmpty()
                ) {
                
                JOptionPane.showMessageDialog(this, "No se puede registrar. Por favor llene todos los campos","ERROR",JOptionPane.ERROR_MESSAGE);
                
            } else {
                boolean resultado;
                //Si el estudiante no existe y se quiere guardar en el sistema
                if (estadoGuardar == 0) {
                ...
                } //Si el estudiante ya existe y se quieren actualizar sus datos
                else if (estadoGuardar == 1) {
                    //Si solo se quiere actualizar sus datos personales sin huellas
        ...
        if (atributo.length() < 11) {
            try {
                ...
                if (rst.next()) {
                    ...
                    //Miarar y marcar en la tabla si un estudiante tiene una huella registrada
                    if (rst.getBlob("huella") == null) {
                        datos[3] = "No";
                    } else {
                        datos[3] = "Si";
                    }
    ...
    public void noTeclearLetras(KeyEvent evt) {
        if (Character.isLetter((char) evt.getKeyChar()) || Character.isSpaceChar((char) evt.getKeyChar())) {
    ...
    private void limpiarFormulario() {
        ...
        jButtonTomarHuella.setEnabled(true);
     ...
     * 
     */
    public void validarEspacios(JTextField nombre,JTextField apellidos,JTextField documentos,
            JTextField grado,JTextField grupo,JTextField jornada, JTextField zonaAlumno){
    ...
    private javax.swing.JButton jButtonTomarHuella;
